...
#define dnload_glDrawArraysInstanced glDrawArraysInstanced
...
#define dnload_glDrawArraysInstanced g_symbol_table.glDrawArraysInstanced
...
static struct SymbolTableStruct
{
  ...
  void (DNLOAD_APIENTRY *glDrawArraysInstanced)(GLenum, GLint, GLsizei, GLsizei);
  int (*rand)(void);
...
} g_symbol_table =
{
  ...
  (void (DNLOAD_APIENTRY *)(GLenum, GLint, GLsizei, GLsizei))0xe6fe8ecc,
  (int (*)(void))0xe83af065,
